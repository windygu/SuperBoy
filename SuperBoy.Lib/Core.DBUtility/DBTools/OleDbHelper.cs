...
namespace Core.DBUtility
{
    ...
    public class OleDbHelper
    {
        ...
        {
            _connectionString = string.Format(AccessPrefix, accessFilePath);
        }
        ...
        public bool TestConnection()
        {
            ...
            using (DbConnection connection = new OleDbConnection(_connectionString))
            {
                connection.Open();
        ...
        {
            var command = new OleDbCommand();
            var connection = GetOleDbConnection();
            try
            {
                PrepareCommand(command, connection, cmdText, p);
        ...
        {
            var ds = new DataSet();
            var adapter = new OleDbDataAdapter(sql, _connectionString);
            adapter.Fill(ds);
            return ds;
        }
