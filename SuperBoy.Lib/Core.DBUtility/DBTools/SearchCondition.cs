...
namespace Core.DBUtility
{
    ...
    public class SearchCondition
    {
        ...
        {
            this._conditionTable.Add(System.Guid.NewGuid()/*fielName*/, new SearchInfo(fielName, fieldValue, sqlOperator));
            return this;
        }
        ...
        {
            this._conditionTable.Add(System.Guid.NewGuid()/*fielName*/, new SearchInfo(fielName, fieldValue, sqlOperator, excludeIfEmpty));
            return this;
        }
        ...
        {
            this._conditionTable.Add(System.Guid.NewGuid()/*fielName*/, new SearchInfo(fielName, fieldValue, sqlOperator, excludeIfEmpty, groupName));
            return this;
        } 
        ...
        public string BuildConditionSql(DatabaseType dbType)
        {
            ...
            foreach (DictionaryEntry de in this._conditionTable)
            {
                ...
                var typeCode = Type.GetTypeCode(searchInfo.FieldValue.GetType());
        ...
        {
            var htGroupNames = new Hashtable();
            SearchInfo searchInfo = null;
            foreach (DictionaryEntry de in this._conditionTable)
            {
                searchInfo = (SearchInfo)de.Value;
