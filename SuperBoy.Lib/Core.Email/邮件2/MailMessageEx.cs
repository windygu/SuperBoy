...
namespace EmailHelp
{
    ...
    public class MailMessageEx : MailMessage
    {
        ...
        public DateTime DeliveryDate
        {
            get
            {
                var date = GetHeader(MailHeaders.Date);
        ...
        public MailAddress ReturnAddress
        {
            get
            {
                var replyTo = GetHeader(MailHeaders.ReplyTo);
        ...
        public ContentDisposition ContentDisposition
        {
            get
            {
                var contentDisposition = GetHeader(MimeHeaders.ContentDisposition);
        ...
        public ContentType ContentType
        {
            get
            {
                var contentType = GetHeader(MimeHeaders.ContentType);
        ...
        public static MailMessageEx CreateMailMessageFromEntity(MimeEntity entity)
        {
            ...
            string value;
            foreach (var key in entity.Headers.AllKeys)
            {
...
#pragma warning restore 618
        ...
        {
            foreach (var address in GetMailAddresses(addressList))
            {
