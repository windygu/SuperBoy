...
namespace Core.Web
{
    ...
    public class JavaScriptHelper
    {
        ...
        {
            var js = "<script language=javascript>alert('{0}');</script>";
        ...
        {
            var js = "<script language=javascript>alert('{0}');window.location.replace('{1}')</script>";
        ...
        {
            var js = @"<Script language='JavaScript'>alert('{0}');history.go({1});</Script>";
        ...
        public static void GoHistory(int value)
        {
            ...
            var js = @"<Script language='JavaScript'> history.go({0});  </Script>";
        ...
        {
            var js = @"<Script language='JavaScript'>parent.opener=null;window.close();</Script>";
        ...
        {
            var js = @"<script>try{top.location=""" + url + @"""}catch(e){location=""" + url + @"""}</script>";
            HttpContext.Current.Response.Write(js);
        }
        ...
        {
            var js = "<script language=javascript>window.top.location.replace('{0}')</script>";
        ...
        {
            var js = "<script language=javascript>alert('{0}');window.top.location.replace('{1}')</script>";
            HttpContext.Current.Response.Write(string.Format(js, message, toUrl));
        }
        #endregion
        ...
        {
            var js = @"<Script language='JavaScript'>opener.location.reload(); </Script>";
            HttpContext.Current.Response.Write(js);
        }
        #endregion
        ...
        {
            var js = @"<Script language='JavaScript'>window.location.replace('{0}'); </Script>";
        ...
        {
            var js = @"<Script language='JavaScript'>window.open('" + url + @"','','height=" + heigth + ",width=" + width + ",top=" + top + ",left=" + left + ",location=no,menubar=no,resizable=yes,scrollbars=yes,status=yes,titlebar=no,toolbar=no,directories=no');</Script>";
            HttpContext.Current.Response.Write(js);
        }
        #endregion
        ...
        {
            var js = @"<Script language='JavaScript'> parent.window.location.replace('{0}'); </Script>";
            js = string.Format(js, url);
            HttpContext.Current.Response.Write(js);
        }
        #endregion
        ...
        {
            var script = isScriptEnd ? "return false;" : "";
