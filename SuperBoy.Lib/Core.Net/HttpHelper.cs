                ...
                using (_response = (HttpWebResponse)_request.GetResponse())
                {
                    ...
                    if (responseByte != null & responseByte.Length > 0)
                    {
                        ...
                        if (_encoding == null)
                        {
                            ...
                            var c = (meta.Groups.Count > 1) ? meta.Groups[2].Value.ToLower() : string.Empty;
                            if (c.Length > 2)
                                _encoding = Encoding.GetEncoding(c.Trim().Replace("\"", "").Replace("'", "").Replace(";", "").Replace("iso-8859-1", "gbk"));
                            else
                            {
