...
namespace Core.Net
{
    ...
    public class ProxyHelper
    {
        ...
        private const int InternetOptionRefresh = 0x000025;
        private const int InternetOptionSettingsChanged = 0x000027;
        #endregion
        ...
        public static bool TestProxy(ProxySettingEntity setting, TestEntity te)
        {
            if (setting == null)
                return false;
            var webRequest = (HttpWebRequest)WebRequest.Create(te.TestUrl);
            ...
            var html = GetHtmlString(response, Encoding.GetEncoding(te.TestWebEncoding));
            response.Close();
