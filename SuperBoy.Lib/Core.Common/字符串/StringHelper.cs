...
namespace Core.Common
{
    ...
    public class StringHelper
    {
        ...
        public static string Cut(string content, int length, string addstr)
        {
            ...
            //如果截过则加上半个省略号
            var mybyte = System.Text.Encoding.Default.GetBytes(content);
...
///// <summary>
        ...
        {
            string result = null;
            var tempString = sourceString.Split(splitChar);
