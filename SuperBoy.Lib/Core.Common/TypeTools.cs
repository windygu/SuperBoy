...
namespace Core.Common
{
    public class TypeTools
    {
        ...
        public static bool IsCompriseStr(string str, string stringarray, string strsplit)
        {
            ...
            str = str.ToLower();
            var stringArray = StringHelper.SplitString(stringarray.ToLower(), strsplit);
        ...
        public static bool InIpArray(string ip, string[] iparray)
        {
            ...
            var userip = StringHelper.SplitString(ip, @".");
            for (var ipIndex = 0; ipIndex < iparray.Length; ipIndex++)
            {
                var tmpip = StringHelper.SplitString(iparray[ipIndex], @".");
                var r = 0;
