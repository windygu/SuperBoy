...
namespace Core.Common
{
    ...
    public class EnumUtils
    {
        ...
        public static Dictionary<string, string> GetValueName(Type enumType)
        {
            ...
            {
                var e = (Enum)o;
                var value = Convert.ChangeType(o, underlyingType).ToString();
        ...
        public static T GetEnum<T>(string str)
        {
            ...
            var o = Convert.ChangeType(str, underlyingType);
            ...
            {
                var c = typeof(T).GetConstructor(new Type[] { nullableType });
        ...
        {
            var attributes = type.GetCustomAttributes(typeof(FlagsAttribute), true);
        ...
        private static EnumAttribute GetAttribute(Enum value)
        {
            ...
            else
            {
                ...
                var attributes = field.GetCustomAttributes(typeof(EnumAttribute), true);
