...
namespace Core.Collections
{
        ...
        IEnumerable<TValue>
    {
        ...
        public void Insert(int index, TKey key, TValue value)
        {
            ...
            this._dictionary.Add(key, value);
            this._list.Insert(index, new KeyValuePair<TKey, TValue>(key, value));
        }
        ...
        public virtual ICollection<TKey> Keys
        {
            get
            {
                ...
                for (var index = 0; index < this._list.Count; index++)
                {
                    var keyValue = this._list[index];
        ...
        {
            var flag = this._dictionary.Remove(key);
        ...
        public void RemoveAt(int index)
        {
            ...
            var keyValue = this._list[index];
            this._dictionary.Remove(keyValue.Key);
        ...
        {
            var flag = this._dictionary.TryGetValue(key, out value);
            return flag;
        }
        ...
        {
            this._dictionary.GetObjectData(info, context);
        }
        ...
        {
            this._dictionary.OnDeserialization(sender);
        } // OnDeserialization
        ...
        {
            return new OrderedDictionaryEnumerator<TKey, TValue>(this._list);
        }
