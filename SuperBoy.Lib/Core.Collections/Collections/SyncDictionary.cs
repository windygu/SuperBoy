    ...
    internal class SyncDictionary<TKey, TValue> : Dictionary<TKey, TValue>
    {
        ...
        public new KeyCollection Keys
        {
            get
            {
                ...
                lock (this._dictionary)
                {
                    collection = new KeyCollection(this._dictionary);
                }
                return collection;
        ...
        public new ValueCollection Values
        {
            get
            {
                ...
                lock (this._dictionary)
                {
                    collection = new ValueCollection(this._dictionary);
                }
                return collection;
        ...
        public new IEqualityComparer<TKey> Comparer
        {
            get
            {
                ...
                lock (this._dictionary)
                {
                    tempComparer = this._dictionary.Comparer;
                }
                return tempComparer;
            }
        }
        ...
        public new Enumerator GetEnumerator()
        {
            ...
            lock (this._dictionary)
            {
                temp = this._dictionary.GetEnumerator();
            } // lock
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("ParentTable", this._dictionary, typeof(Dictionary<TKey, TValue>));
        }
        ...
        internal SyncDictionary(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            this._dictionary = (Dictionary<TKey, TValue>)info.GetValue("ParentTable", typeof(Dictionary<TKey, TValue>));
        ...
        public new bool ContainsValue(TValue value)
        {
            ...
            lock (this._dictionary)
            {
                flag = this._dictionary.ContainsValue(value);
            }
            return flag;
        } // ContainsValue
