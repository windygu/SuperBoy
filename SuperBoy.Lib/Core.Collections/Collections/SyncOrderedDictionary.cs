...
namespace Core.Collections
{
    ...
    internal class SyncOrderedDictionary<TKey, TValue> : OrderedDictionary<TKey, TValue>
    {
        ...
        {
            bool flag;
            lock (this._dictionarytable)
            {
                flag = this._dictionarytable.TryGetValue(key, out value);
            } // lock
        ...
        public override TValue this[TKey key]
        {
            get
            {
                return this._dictionarytable[key];
            }
            set
            {
                lock (this._dictionarytable)
                {
                    this._dictionarytable[key] = value;
                } // lock
            } // set
        }
        ...
        public override TValue this[int index]
        {
            get
            {
                return this._dictionarytable[index];
            }
            set
            {
                lock (this._dictionarytable)
                {
                    this._dictionarytable[index] = value;
                } // lock
            }
        }
        ...
        public override ICollection<TKey> Keys
        {
            get
            {
                ...
                lock (this._dictionarytable)
                {
                    keys = this._dictionarytable.Keys;
                }
                return keys;
        ...
        public override ICollection<TValue> Values
        {
            get
            {
                ...
                lock (this._dictionarytable)
                {
                    collection = this._dictionarytable.Values;
                }
                return collection;
        ...
        public override IEqualityComparer<TKey> Comparer
        {
            get
            {
                ...
                lock (this._dictionarytable)
                {
                    tempComparer = this._dictionarytable.Comparer;
                }
                return tempComparer;
            }
        }
        ...
        public override int Count
        {
            get
            {
                return this._dictionarytable.Count;
        ...
        public override bool Remove(TKey key)
        {
            lock (this._dictionarytable)
            {
                return this._dictionarytable.Remove(key);
            }
        ...
        public override OrderedDictionaryEnumerator<TKey, TValue> GetEnumerator()
        {
            ...
            lock (this._dictionarytable)
            {
                temp = this._dictionarytable.GetEnumerator();
            } // lock

            return temp;
        } // GetEnumerator

        private OrderedDictionary<TKey, TValue> _dictionarytable;
        ...
        public override void Add(TKey key, TValue value)
        {
            lock (this._dictionarytable)
            {
                this._dictionarytable.Add(key, value);
            }
        }
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("ParentTable", this._dictionarytable, typeof(Dictionary<TKey, TValue>));
        }
        ...
        public override void CopyTo(KeyValuePair<TKey, TValue>[] array, int index)
        {
            lock (this._dictionarytable)
            {
                this._dictionarytable.CopyTo(array, index);
            }
        ...
        {
            return this._dictionarytable.ContainsKey(key);
        } // ContainsKey
        ...
        public override bool ContainsValue(TValue value)
        {
            ...
            lock (this._dictionarytable)
            {
                flag = this._dictionarytable.ContainsValue(value);
            }
            return flag;
        } // ContainsValue
