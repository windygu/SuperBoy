...
namespace Core.Drawing
{
    ...
    {
        private static Hashtable _htmimes = new Hashtable();
        ...
        /// <param name="path">原服务器图片路径</param>
        /// <param name="Path_sypf">水印图片路径</param>
        public static void AddWaterPic(string path, string pathSypf)
        {
            try
            {
        ...
        {
            _htmimes[".jpe"] = "image/jpeg";
            _htmimes[".jpeg"] = "image/jpeg";
            _htmimes[".jpg"] = "image/jpeg";
            _htmimes[".png"] = "image/png";
            _htmimes[".tif"] = "image/tiff";
            _htmimes[".tiff"] = "image/tiff";
            _htmimes[".bmp"] = "image/bmp";
        }
