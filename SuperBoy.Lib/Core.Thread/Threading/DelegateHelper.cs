...
namespace Core.Threads
{
    ...
    {
        private static WaitCallback _dynamicInvoker = new WaitCallback(DynamicInvoke);
        ...
        {
            return AbortableThreadPool.QueueUserWorkItem(_dynamicInvoker, new TargetInfo(target, args));
        }
        ...
        {
            return AbortableThreadPool.QueueUserWorkItem(_dynamicInvoker, new TargetInfo(target, null));
        }
