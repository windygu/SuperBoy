...
namespace SuperBoy.YSQL.Lib
{
    ...
    public static class FileHelper
    {
        ...
        public static void WriteFile(string path, string strings)
        {
            ...
            var f2 = new StreamWriter(path, true, System.Text.Encoding.UTF8);
        ...
        public static string ReadFile(string path)
        {
            ...
            {
                var f2 = new StreamReader(path, System.Text.Encoding.GetEncoding("gb2312"));
                s = f2.ReadToEnd();
                f2.Close();
                f2.Dispose();
            }
        ...
        public static bool CompareFilesHash(string fileName1, string fileName2)
        {
            using (var hashAlg = HashAlgorithm.Create())
            {
                ...
                {
                    var hashBytes1 = hashAlg.ComputeHash(fs1);
                    var hashBytes2 = hashAlg.ComputeHash(fs2);
    ...
    /// </summary>
    public static class FileStreamHelp
    {
    ...
    public class DirectoryUtil
    {
        ...
        public static bool IsWriteable(string path)
        {
            ...
            try
            {
                var testFileName = ".test." + Guid.NewGuid().ToString().Substring(0, 5);
        ...
        public static bool IsDiskSpaceEnough(string path, ulong requiredSpace)
        {
            ...
            var freeSpace = GetFreeSpace(root);
        ...
        /// 读取目录列表
        /// </summary>
        public static IEnumerable<FileItem> GetDirectoryItems(string path)
        {
            var list = new List<FileItem>();
